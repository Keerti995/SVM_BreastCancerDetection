...
print("---train")
# A model with radial basis function kernel is used with the penalty for misclassifying data is set to 1000 and decision boundary is set to 0.1 giving broader decision boundary else if it were high then the there would be islands forming depending on each data point
model = svm.SVC(C=1000,kernel='rbf',random_state=0,coef0=300,gamma=0.1) 
